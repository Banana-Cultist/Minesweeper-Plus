...
def voronoi_finite_polygons_2d(vor, radius=None) -> Any:
    """
    ...
    all_ridges: dict[np.int32, list[tuple[np.int32, ...]]] = {}
...
mins = np.tile((0, 0), (vertices.shape[0], 1))
bounded_vertices = np.max((vertices, mins), axis=0)
maxs = np.tile((1, 1), (vertices.shape[0], 1))
