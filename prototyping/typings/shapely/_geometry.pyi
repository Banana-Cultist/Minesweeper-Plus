...
__all__ = ["GeometryType", "get_type_id", "get_dimensions", "get_coordinate_dimension", "get_num_coordinates", "get_srid", "set_srid", "get_x", "get_y", "get_z", "get_exterior_ring", "get_num_points", "get_num_interior_rings", "get_num_geometries", "get_point", "get_interior_ring", "get_geometry", "get_parts", "get_rings", "get_precision", "set_precision", "force_2d", "force_3d"]
...
def get_parts(geometry, return_index=...):
...
def get_rings(geometry, return_index=...):
...
@requires_geos("3.6.0")
@multithreading_enabled
def set_precision(geometry, grid_size, mode=..., **kwargs):
...
@multithreading_enabled
def force_3d(geometry, z=..., **kwargs):
