...
__all__ = ["BufferCapStyle", "BufferJoinStyle", "boundary", "buffer", "offset_curve", "centroid", "clip_by_rect", "concave_hull", "convex_hull", "delaunay_triangles", "segmentize", "envelope", "extract_unique_points", "build_area", "make_valid", "normalize", "node", "point_on_surface", "polygonize", "polygonize_full", "remove_repeated_points", "reverse", "simplify", "snap", "voronoi_polygons", "oriented_envelope", "minimum_rotated_rectangle", "minimum_bounding_circle"]
...
@multithreading_enabled
def buffer(geometry, distance, quad_segs=..., cap_style=..., join_style=..., mitre_limit=..., single_sided=..., **kwargs):
    """
...
@multithreading_enabled
def offset_curve(geometry, distance, quad_segs=..., join_style=..., mitre_limit=..., **kwargs):
    """
...
@multithreading_enabled
def concave_hull(geometry, ratio=..., allow_holes=..., **kwargs):
...
@multithreading_enabled
def delaunay_triangles(geometry, tolerance=..., only_edges=..., **kwargs):
...
@multithreading_enabled
def simplify(geometry, tolerance, preserve_topology=..., **kwargs):
...
@multithreading_enabled
def voronoi_polygons(geometry, tolerance=..., extend_to=..., only_edges=..., **kwargs):
