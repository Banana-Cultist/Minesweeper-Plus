...
class STRtree:
    ...
    def __reduce__(self): # -> tuple[Type[STRtree], tuple[NDArray[object_]]]:
        ...
    
    @property
    def geometries(self): # -> NDArray[object_]:
        """
    ...
    def query(self, geometry, predicate=..., distance=...):
        """
...
and optional distances
    ...
    @requires_geos("3.6.0")
    def query_nearest(self, geometry, max_distance=..., return_distance=..., exclusive=..., all_matches=...): # -> tuple[Unknown, Unknown]:
