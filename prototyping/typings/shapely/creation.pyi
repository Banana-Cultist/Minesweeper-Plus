...
__all__ = ["points", "linestrings", "linearrings", "polygons", "multipoints", "multilinestrings", "multipolygons", "geometrycollections", "box", "prepare", "destroy_prepared", "empty"]
@multithreading_enabled
def points(coords, y=..., z=..., indices=..., out=..., **kwargs):
...
@multithreading_enabled
def linestrings(coords, y=..., z=..., indices=..., out=..., **kwargs):
...
@multithreading_enabled
def linearrings(coords, y=..., z=..., indices=..., out=..., **kwargs):
...
@multithreading_enabled
def polygons(geometries, holes=..., indices=..., out=..., **kwargs):
...
@multithreading_enabled
def box(xmin, ymin, xmax, ymax, ccw=..., **kwargs):
    """Create box polygons.
...
@multithreading_enabled
def multipoints(geometries, indices=..., out=..., **kwargs):
...
@multithreading_enabled
def multilinestrings(geometries, indices=..., out=..., **kwargs):
...
@multithreading_enabled
def multipolygons(geometries, indices=..., out=..., **kwargs):
...
@multithreading_enabled
def geometrycollections(geometries, indices=..., out=..., **kwargs):
...
def empty(shape, geom_type=..., order=...):
