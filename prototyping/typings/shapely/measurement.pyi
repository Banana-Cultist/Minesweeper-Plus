...
__all__ = ["area", "distance", "bounds", "total_bounds", "length", "hausdorff_distance", "frechet_distance", "minimum_clearance", "minimum_bounding_radius"]
...
def total_bounds(geometry, **kwargs): # -> NDArray[Unknown]:
...
@multithreading_enabled
def hausdorff_distance(a, b, densify=..., **kwargs):
...
@requires_geos("3.7.0")
@multithreading_enabled
def frechet_distance(a, b, densify=..., **kwargs):
