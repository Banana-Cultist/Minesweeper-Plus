...
class csc_matrix(_cs_matrix):
    ...
    def nonzero(self): # -> tuple[ndarray[Any, dtype[int64 | int32]] | Unknown | ndarray[Any, dtype[Unknown]], ndarray[Any, dtype[int64 | int32]]]:
        ...
    ...
    def getcol(self, i): # -> Self@csc_matrix | _cs_matrix:
