...
def find(A): # -> tuple[ndarray[Any, dtype[int64 | int32]] | Unknown | ndarray[Any, _dtype], ndarray[Any, dtype[int64 | int32]] | Unknown | ndarray[Any, _dtype], ndarray[Any, dtype[Unknown]] | Unknown | ndarray[Any, dtype[float64]] | ndarray[Any, dtype[Any]]]:
...
def tril(A, k=..., format=...): # -> spmatrix | coo_matrix | Any:
...
def triu(A, k=..., format=...): # -> spmatrix | coo_matrix | Any:
