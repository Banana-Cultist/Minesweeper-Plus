...
class BarrierSubproblem:
    ...
    def function_and_constraints(self, z): # -> tuple[Unknown, NDArray[Unknown]]:
    ...
    def gradient_and_jacobian(self, z): # -> tuple[NDArray[Unknown], Unknown | csr_matrix]:
