...
def initial_constraints_as_canonical(n, prepared_constraints, sparse_jacobian): # -> tuple[NDArray[Unknown] | NDArray[float64], NDArray[Unknown] | NDArray[float64], Unknown | Self@_data_matrix | csr_matrix | csc_matrix | spmatrix | coo_matrix | Any | NDArray[Unknown] | NDArray[float64], Unknown | Self@_data_matrix | csr_matrix | csc_matrix | spmatrix | coo_matrix | Any | NDArray[Unknown] | NDArray[float64]]:
