...
from typing import Any, Callable, Iterable, Optional, TYPE_CHECKING, Tuple, Union
...
ERROR_MESSAGES = ...
SUCCESS_MESSAGES = ...
def direct(func: Callable[[npt.ArrayLike, Tuple[Any]], float], bounds: Union[Iterable, Bounds], *, args: tuple = ..., eps: float = ..., maxfun: Union[int, None] = ..., maxiter: int = ..., locally_biased: bool = ..., f_min: float = ..., f_min_rtol: float = ..., vol_tol: float = ..., len_tol: float = ..., callback: Optional[Callable[[npt.ArrayLike], NoneType]] = ...) -> OptimizeResult:
    """
