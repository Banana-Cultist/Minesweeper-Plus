...
def trimmed_mean_ci(data, limits=..., inclusive=..., alpha=..., axis=...): # -> NDArray[Unknown]:
    """
...
def mjci(data, prob=..., axis=...): # -> NDArray[float_]:
    """
...
def mquantiles_cimj(data, prob=..., alpha=..., axis=...): # -> tuple[Unknown, Unknown]:
    """
