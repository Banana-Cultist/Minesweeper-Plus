...
def solve(a, b, sym_pos=..., lower=..., overwrite_a=..., overwrite_b=..., check_finite=..., assume_a=..., transposed=...): # -> NDArray[float_]:
    """
...
def solve_circulant(c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...): # -> NDArray[floating[_64Bit] | complex128] | ndarray[Any, _dtype] | NDArray[complex128]:
...
def pinv(a, atol=..., rtol=..., return_rank=..., check_finite=..., cond=..., rcond=...): # -> tuple[Unknown, Unknown]:
    """
...
def pinvh(a, atol=..., rtol=..., lower=..., return_rank=..., check_finite=...): # -> tuple[Unknown, int]:
    """
