...
def expm_frechet(A, E, method=..., compute_expm=..., check_finite=...): # -> tuple[Unknown | Any | ndarray[Any, dtype[Unknown]] | ndarray[Any, dtype[Any]] | ndarray[Any, _dtype], Unknown | Any | ndarray[Any, dtype[Unknown]] | ndarray[Any, dtype[Any]] | ndarray[Any, _dtype]] | Any | ndarray[Any, dtype[Unknown]] | ndarray[Any, dtype[Any]] | ndarray[Any, _dtype]:
    """
...
def expm_frechet_block_enlarge(A, E): # -> tuple[Unknown | ndarray[Any, dtype[Unknown]] | ndarray[Any, dtype[Any]] | ndarray[Any, _dtype], Unknown | ndarray[Any, dtype[Unknown]] | ndarray[Any, dtype[Any]] | ndarray[Any, _dtype]]:
    """
...
ell_table_61 = ...
def expm_frechet_algo_64(A, E): # -> tuple[Unknown | Any, Unknown | Any]:
    ...
...
def expm_frechet_kronform(A, method=..., check_finite=...): # -> NDArray[Unknown]:
    """
