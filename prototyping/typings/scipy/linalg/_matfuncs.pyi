...
feps = ...
_array_precision = ...
def fractional_matrix_power(A, t): # -> NDArray[Any] | Any | NDArray[Unknown] | ndarray[Unknown, Unknown]:
    """
...
def expm(A): # -> NDArray[Unknown] | NDArray[Any] | ndarray[Any, _dtype]:
...
def signm(A, disp=...): # -> Any | tuple[Unknown, Unknown | floating[Any] | Any | float | int]:
    """
