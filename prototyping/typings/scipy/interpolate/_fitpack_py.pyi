...
def splrep(x, y, w=..., xb=..., xe=..., k=..., task=..., s=..., t=..., full_output=..., per=..., quiet=...): # -> tuple[tuple[Unknown, Any, int], Any, Any, str | Type[ValueError] | Type[TypeError] | None] | tuple[Unknown, Any, int]:
    """
...
def splder(tck, n=...): # -> BSpline | tuple[Unknown, Unknown | Any, Unknown]:
    """
