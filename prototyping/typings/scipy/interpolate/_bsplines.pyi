...
class BSpline:
    ...
    **Implementation details**
    ...
    @property
    def tck(self): # -> tuple[NDArray[float64], NDArray[Unknown] | NDArray[complex_ | float_], int]:
    ...
    def integrate(self, a, b, extrapolate=...): # -> list[Unknown] | tuple[Any, ...] | Any:
    ...
    @classmethod
    def from_power_basis(cls, pp, bc_type=...): # -> Self@BSpline:
        r"""
