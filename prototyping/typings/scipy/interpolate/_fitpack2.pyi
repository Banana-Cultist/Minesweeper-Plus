...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    def __call__(self, x, nu=..., ext=...): # -> NDArray[Any] | list[Unknown] | Any:
        """
    ...
    def integral(self, a, b): # -> list[Unknown] | tuple[Any, Any] | Any:
    ...
    def derivatives(self, x): # -> list[Unknown] | Any:
    ...
    def roots(self): # -> list[Unknown] | Any:
...
class _BivariateSplineBase:
    ...
    def __call__(self, x, y, dx=..., dy=..., grid=...): # -> NDArray[float64] | Any:
        """
