...
def clpmn(m, n, z, type=...): # -> tuple[Any, Any]:
...
def comb(N, k, exact=..., repetition=..., legacy=...): # -> ndarray[Unknown, Unknown] | float64 | Any:
...
def factorial(n, exact=...): # -> int | NDArray[float64] | NDArray[Any] | Any:
    """
